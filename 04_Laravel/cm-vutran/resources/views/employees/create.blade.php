  ...
  <div class="p-5" style="width: 60%:">
    ...
    <div class="p-5" style="width: 60%:">
      ...
      <div class="mb-3">
        ...
        <input value="{{ old('base_salary') }}" type="number" class="form-control" id="inputSalary" name="base_salary">
        @error('base_salary')
        <div class="text-danger">{{ $message }}</div>
        @enderror
      </div>
      ...
      <div class="mb-3">
        ...
        <input value="{{ old('allowance') }}" type="number" class="form-control" id="inputAllowance" name="allowance">
        @error('allowance')
        <div class="text-danger">{{ $message }}</div>
        @enderror
      </div>
