        ...
        <div class="p-5" style="width: 60%:">
          ...
          <!-- supply Form -->
            ...
            <div class="mb-3">
              ...
              <input value="{{ old('transaction_name', $supply['transactionName'] ) }}" type="text" class="form-control" id="inputPosition" name="transaction_name">
            ...
            <div class="mb-3">
              ...
              <input value="{{ old('address', $supply['address'] ) }}" type="text" class="form-control" id="inputOffice" name="address">
            @error('address')
                <div class="text-danger">{{ $message }}</div>
            @enderror
            </div>
            ...
            <div class="mb-3">
              ...
              <input value="{{ old('phone_number', $supply['phoneNumber'] ) }}" type="text" class="form-control" id="inputStartDate" name="phone_number">
              @error('phone_number')
                <div class="text-danger">{{ $message }}</div>
            @enderror
            </div>
