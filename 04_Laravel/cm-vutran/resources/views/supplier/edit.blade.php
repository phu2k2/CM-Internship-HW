...
<form id="supplierForm" action="{{ route('suppliers.update', ['supplier' => $supplier->id ]) }}" method="POST">
  ...
  <div class="p-5">
    ...
    <div class="mb-3">
      ...
      <input value="{{ old('company_id', $supplier->company_id) }}" type="text" class="form-control" id="inputId" name="company_id">
      @error('company_id')
    ...
    <div class="mb-3">
      ...
      <input value="{{ old('company_name', $supplier->company_name ) }}" type="text" class="form-control" id="inputName"
        name="company_name">
      @error('company_name')
      <div class="text-danger">{{ $message }}</div>
      @enderror
    ...
    <div class="mb-3">
      ...
      <input value="{{ old('transaction_name', $supplier->transaction_name ) }}" type="text" class="form-control"
    ...
    <div class="mb-3">
      ...
      <input value="{{ old('address', $supplier->address ) }}" type="text" class="form-control" id="inputOffice"
        name="address">
      @error('address')
      <div class="text-danger">{{ $message }}</div>
      @enderror
    ...
    <div class="mb-3">
      ...
      <input value="{{ old('email', $supplier->email ) }}" type="email" class="form-control" id="inputAge" name="email">
      @error('email')
      <div class="text-danger">{{ $message }}</div>
      @enderror
    </div>
    ...
    <div class="mb-3">
      ...
      <input value="{{ old('fax', $supplier->fax) }}" type="text" class="form-control" id="inputSalary" name="fax">
      @error('fax')
      <div class="text-danger">{{ $message }}</div>
      @enderror
    </div>
