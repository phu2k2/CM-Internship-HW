                                ...
                                @foreach ($customers as $key => $customer)
                                    <tr>
                                            ...
                                            <div class="d-flex px-2 py-1">
                                                ...
                                                <div class="d-flex flex-column justify-content-center">
                                                    <a
                                                        ...
                                                        <h6 class="mb-0 text-sm">{{ $customer['company_name'] }}</h6>
                                                    </a>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <span
                                                class="badge badge-sm bg-gradient-success">{{ $customer['transaction_name'] }}</span>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <form id="destroy{{ $customer['id'] }}"
                                                ...
                                                <button type="button" class="btn bg-gradient-danger btn-block mb-3"
                                                    onclick="destroyCategory({{ $customer['id'] }})">
