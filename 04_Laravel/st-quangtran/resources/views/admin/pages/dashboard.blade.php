                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="{{ asset('admin/assets/images/faces/face1.jpg') }}" class="mr-2"
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('admin/assets/images/faces/face2.jpg') }}" class="mr-2"
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('admin/assets/images/faces/face3.jpg') }}" class="mr-2"
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('admin/assets/images/faces/face4.jpg') }}" class="mr-2"
                                                    alt="image"> John Doe
                                            </td>
