                ...
                <form action="{{ route('categories.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" class="form-control" id="basic-icon-default-categoryid" placeholder="TP"
                                aria-label="TP" aria-describedby="basic-icon-default-categoryid2" />
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" id="basic-icon-default-categoryname" class="form-control"
                                placeholder="Thực phẩm" aria-label="Thực phẩm"
