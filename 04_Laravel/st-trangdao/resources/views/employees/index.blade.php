...
<div class="card">
    ...
    <div class="table-responsive text-nowrap">
        ...
        <tbody class="table-border-bottom-0">
            ...
            <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <a href="{{ route('employees.show',['employee' => $employee['id']]) }}">{{$employee['employee_id']}}</a></td>
            <td><span class="badge bg-label-primary me-1">{{$employee['last_name'].' '.$employee['first_name']}}</span></td>
            ...
            <td>
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{ route('employees.edit',['employee' => $employee['id']]) }}"
