...
<div class="col-xl">
    ...
    <form href="{{ route('employees.update', ['employee' => $employee['id']]) }}" method="POST">
        ...
        <div class="col-md-10">
            <input class="form-control" type="text" value="{{$employee['employee_id']}}" id="html5-text-input" />
        </div>
        </div>
        <div class="mb-3 row">
        <label for="html5-search-input" class="col-md-2 col-form-label">Last Name</label>
        <div class="col-md-10">
            <input class="form-control" type="text" value="{{$employee['last_name']}}" id="html5-search-input" />
        </div>
        </div>
        <div class="mb-3 row">
        <label for="html5-search-input" class="col-md-2 col-form-label">First Name</label>
        <div class="col-md-10">
            <input class="form-control" type="text" value="{{$employee['first_name']}}" id="html5-search-input" />
        </div>
        </div>
        <div class="mb-3 row">
        <label for="html5-search-input" class="col-md-2 col-form-label">Birthday</label>
        <div class="col-md-10">
            <input class="form-control" type="date" value="{{ date('Y-m-d', strtotime($employee['birthday']))}}" id="html5-search-input" />
        </div>
        </div>
        <div class="mb-3 row">
        <label for="html5-search-input" class="col-md-2 col-form-label">Start Date</label>
        <div class="col-md-10">
            <input class="form-control" type="date" value="{{ date('Y-m-d', strtotime($employee['start_date']))}}" id="html5-search-input" />
        </div>
        </div>
        <div class="mb-3 row">
        <label for="html5-search-input" class="col-md-2 col-form-label">Address</label>
        <div class="col-md-10">
            <input class="form-control" type="text" value="{{$employee['address']}}" id="html5-search-input" />
        </div>
        </div>
        <div class="mb-3 row">
        <label for="html5-search-input" class="col-md-2 col-form-label">Phone</label>
        <div class="col-md-10">
            <input class="form-control" type="text" value="{{$employee['phone']}}" id="html5-search-input" />
        </div>
        </div>
        <div class="mb-3 row">
        <label for="html5-search-input" class="col-md-2 col-form-label">Base Salary</label>
        <div class="col-md-10">
            <input class="form-control" type="text" value="{{$employee['base_salary']}}" id="html5-search-input" />
        </div>
        </div>
        <div class="mb-3 row">
        <label for="html5-search-input" class="col-md-2 col-form-label">Allowance</label>
        <div class="col-md-10">
            <input class="form-control" type="text" value="{{$employee['allowance']}}" id="html5-search-input" />
        </div>
        </div>
