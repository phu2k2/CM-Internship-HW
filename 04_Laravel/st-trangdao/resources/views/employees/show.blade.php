                    ...
                    <div class="mb-3">
                        ...
                        <div class="col-md-10">
                            <span id="basic-icon-default-employeeid2" class="input-group-text"><i
                                    class='bx bx-id-card'></i>{{ $employee['id'] }}</span>
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="col-md-10">
                            <span id="basic-icon-default-employeeid2" class="input-group-text"><i
                                    class='bx bxs-barcode'></i>{{ $employee['employee_id'] }}</span>
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="col-md-10">
                            <span id="basic-icon-default-lastname2" class="input-group-text"><i
                                    class='bx bx-user-circle'></i>{{ $employee['last_name'] . ' ' . $employee['first_name'] }}</span>
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="col-md-10">
                            <span id="basic-icon-default-birthday2" class="input-group-text"><i
                                    class='bx bx-calendar'></i>{{ date('d-m-Y', strtotime($employee['birthday'])) }}</span>
                        </div>
                        <div class="mb-3">
                            ...
                            <div class="col-md-10">
                                <span id="basic-icon-default-startdate2" class="input-group-text"><i
                                        class='bx bx-calendar-check'></i>{{ date('d-m-Y', strtotime($employee['start_date'])) }}</span>
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <div class="col-md-10">
                                <span id="basic-icon-default-address2" class="input-group-text"><i
                                        class="bx bx-buildings"></i>{{ $employee['address'] }}</span>
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="col-md-10">
                                <span class="input-group-text"><i
                                        class='bx bx-money'></i>{{ $employee['base_salary'] }}</span>
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <div class="col-md-10">
                                <span id="basic-icon-default-allowance2" class="input-group-text"><i
                                        class='bx bx-dollar-circle'></i>{{ $employee['allowance'] }}</span>
                            </div>
                        </div>
                    </div>
                </form>
