            ...
            <form action="{{ route('employees.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        <span id="basic-icon-default-employeeid2" class="input-group-text"><i
                                class='bx bxs-barcode'></i></span>
                        <input type="text" class="form-control" id="basic-icon-default-employeeid" placeholder="A001"
                            aria-label="A001" aria-describedby="basic-icon-default-employeeid2" />
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <input type="text" class="form-control" id="basic-icon-default-lastname" placeholder="Đào"
                            aria-label="Đào" aria-describedby="basic-icon-default-lastname2" />
                    </div>
                </div>
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <input type="text" id="basic-icon-default-firstname" class="form-control"
                            placeholder="Thủy Trang" aria-label="Thủy Trang"
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        <span id="basic-icon-default-birthday2" class="input-group-text"><i
                                class='bx bx-calendar'></i></span>
                        <input type="date" id="basic-icon-default-birthday" class="form-control"
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        <span id="basic-icon-default-startdate2" class="input-group-text"><i
                                class='bx bx-calendar-check'></i></span>
                        <input type="date" id="basic-icon-default-startdate" class="form-control"
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <input type="text" id="basic-icon-default-address" class="form-control" placeholder="Đà Nẵng"
                            aria-label="Đà Nẵng" aria-describedby="basic-icon-default-address2" />
                    </div>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <input type="text" id="basic-icon-default-email" class="form-control"
                            placeholder="10000000" aria-label="10000000"
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                        <span id="basic-icon-default-allowance2" class="input-group-text"><i
                                class='bx bx-dollar-circle'></i></span>
                        <input id="basic-icon-default-allowance" class="form-control" placeholder="500000"
                            aria-label="500000" aria-describedby="basic-icon-default-fax2">
                    </div>
                </div>
