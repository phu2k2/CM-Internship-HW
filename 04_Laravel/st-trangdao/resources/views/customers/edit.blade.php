...
<div class="col-xl">
    ...
    <form href="{{ route('customers.update', ['customer' => $customer['id']]) }}" method="POST">
        ...
        <div class="col-md-10">
            <input class="form-control" type="text" value="{{$customer['company_name']}}" id="html5-text-input" />
        </div>
        </div>
        <div class="mb-3 row">
        <label for="html5-search-input" class="col-md-2 col-form-label">Transaction Name</label>
        <div class="col-md-10">
            <input class="form-control" type="text" value="{{$customer['transaction_name']}}" id="html5-search-input" />
        </div>
        </div>
        <div class="mb-3 row">
        <label for="html5-search-input" class="col-md-2 col-form-label">Address</label>
        <div class="col-md-10">
            <input class="form-control" type="text" value="{{$customer['address']}}" id="html5-search-input" />
        </div>
        </div>
        <div class="mb-3 row">
        <label for="html5-search-input" class="col-md-2 col-form-label">Email</label>
        <div class="col-md-10">
            <input class="form-control" type="text" value="{{$customer['email']}}" id="html5-search-input" />
        </div>
        </div>
        <div class="mb-3 row">
        <label for="html5-search-input" class="col-md-2 col-form-label">Phone</label>
        <div class="col-md-10">
            <input class="form-control" type="text" value="{{$customer['phone']}}" id="html5-search-input" />
        </div>
        </div>
        <div class="mb-3 row">
        <label for="html5-search-input" class="col-md-2 col-form-label">Fax</label>
        <div class="col-md-10">
            <input class="form-control" type="text" value="{{$customer['fax']}}" id="html5-search-input" />
        </div>
        </div>
        <a href="{{ route('customers.index') }}" type="submit" class="btn rounded-pill btn-outline-warning">Cancel</a>
