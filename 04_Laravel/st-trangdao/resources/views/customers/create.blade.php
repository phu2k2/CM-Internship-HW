        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <input
                    type="text"
                    class="form-control"
                    id="basic-icon-default-companyname"
                    placeholder="Công ty ABC"
                    aria-label="Công ty ABC"
            ...
            <div class="mb-3">
                ...
                <input
                    type="text"
                    id="basic-icon-default-transactionname"
                    class="form-control"
            ...
            <div class="mb-3">
                ...
                ></span>
                <input
                    id="basic-icon-default-fax"
                    class="form-control"
                    placeholder="6587 998 941"
                    aria-label="6587 998 941"
