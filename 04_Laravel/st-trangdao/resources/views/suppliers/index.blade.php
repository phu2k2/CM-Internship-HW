...
<div class="card">
    ...
    <div class="table-responsive text-nowrap">
        ...
        <tbody class="table-border-bottom-0">
            ...
            <td><a class="badge bg-label-primary me-1" href="{{ route('suppliers.show',['supplier' => $supplier['id']]) }}">{{ $supplier['company_id'] }}</a></td>
            <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{$supplier['company_name']}}</strong></td>
            ...
            <td>
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{ route('suppliers.edit',['supplier' => $supplier['id']]) }}"
