        ...
        <div class="card-body">
            <form href="{{ route('suppliers.update', ['supplier' => $supplier['id']]) }}" method="POST">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                        <span id="basic-icon-default-categoryid2"
                            class="fab fa-angular fa-lg text-danger me-3">{{ $supplier['id'] }}</span>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="html5-text-input" class="col-md-2 col-form-label">Company ID</label>
                    <div class="col-md-10">
                        <input class="form-control" type="text" value="{{ $supplier['company_id'] }}"
                            id="html5-text-input" />
                    </div>
                </div>
                <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                        <input class="form-control" type="text" value="{{ $supplier['company_name'] }}"
                            id="html5-text-input" />
                    </div>
                </div>
                <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                        <input class="form-control" type="text" value="{{ $supplier['transaction_name'] }}"
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                        <input class="form-control" type="text" value="{{ $supplier['address'] }}"
                            id="html5-search-input" />
                    </div>
                </div>
                <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                        <input class="form-control" type="text" value="{{ $supplier['email'] }}"
                            id="html5-search-input" />
                    </div>
                </div>
                <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                        <input class="form-control" type="text" value="{{ $supplier['phone'] }}"
                            id="html5-search-input" />
                    </div>
                </div>
                <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                        <input class="form-control" type="text" value="{{ $supplier['fax'] }}"
                            id="html5-search-input" />
                    </div>
                </div>
