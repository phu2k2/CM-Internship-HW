...
INSERT INTO `QLBH`.`NHANVIEN` (`MaNhanVien`, `Ho`, `Ten`, `NgaySinh`, `NgayLamViec`, `DiaChi`, `DienThoai`, `LuongCoBan`, `PhuCap`) VALUES
...
DiaChi AS "Địa chỉ ",YEAR(NgayLamViec) AS "Năm bắt đầu làm việc"
FROM NHANVIEN;
