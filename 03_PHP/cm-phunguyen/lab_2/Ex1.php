...
function isWeekend($appointmentDateTime)
{
    ...
    if ($appointmentDay == '20') {
        ...
        if ($dayOfWeekApp == '0') {
            ...
            echo "Lịch hẹn sẽ đổi lại ngày " . (string)$nearestSunDay.".";
        }
    } else {
        ...
        if ($appointmentDay >= '20') {
            ...
            $interval = 20 + (int)$dayNumberOfMonth - (int)$appointmentDay; 
        } else {
            $interval = 20 - (int)$appointmentDay;
        }
        echo "\n";
        echo "Khoảng thời gian đến ngày 20 gần nhất là: " . (string)$interval . " ngày.";
    }
}
